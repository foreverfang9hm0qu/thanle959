...
private List<String> mLstFeatureType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (parent.getItemAtPosition(position) instanceof hcm.ditagis.com.tanhoa.qlts.adapter.FeatureViewMoreInfoAdapter.Item) {
...
//                        });
                ...
                builder.setPositiveButton("Cập nhật", new android.content.DialogInterface.OnClickListener() {
                    ...
                    public void onClick(android.content.DialogInterface dialog, int which) {
                        ...
                        new hcm.ditagis.com.tanhoa.qlts.async.NotifyDataSetChangeAsync(TraCuuActivity.this).execute(adapter);
                    }
                });
