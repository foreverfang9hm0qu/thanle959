...
//        configs.add(new Config(mContext.getResources().getString(R.string.URL_HANH_CHINH_XA),mContext.getResources().getString(R.string.ID_HANH_CHINH_XA), mContext.getResources().getString(R.string.TITLE_HANH_CHINH_XA), mContext.getResources().getInteger(R.integer.MIN_SCALE_HANH_CHINH_XA), mContext.getString(R.string.group_base_map)));
        configs.add(new Config(mContext.getResources().getString(R.string.URL_HANH_CHINH_HUYEN),mContext.getResources().getString(R.string.ID_HANH_CHINH_HUYEN), mContext.getResources().getString(R.string.TITLE_HANH_CHINH_HUYEN), mContext.getResources().getInteger(R.integer.MIN_SCALE_HANH_CHINH_HUYEN), mContext.getString(R.string.group_base_map)));
