...
public class NotifyTraCuuAdapterValueChangeAsync extends AsyncTask<TraCuSuCoAdapter, Void, Void> {
    ...
    @Override
    protected Void doInBackground(TraCuSuCoAdapter... params) {
        final TraCuSuCoAdapter adapter = params[0];
        try {
            Thread.sleep(500);
